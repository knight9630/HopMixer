...
parser.add_argument('--d_model', type=int, default=16, help='dimension of model')#原16
...
parser.add_argument('--use_norm', type=int, default=0, help='whether to use normalize; True 1 False 0')#0会跳过归一化
parser.add_argument('--down_sampling_layers', type=int, default=2, help='num of down sampling layers')#3
