...
parser.add_argument('--root_path', type=str, default='../data/illness/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='illness.csv', help='data file')
parser.add_argument('--features', type=str, default='M',
                    help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate')
parser.add_argument('--target', type=str, default='OT', help='target feature in S or MS task')
parser.add_argument('--freq', type=str, default='h',
                    help='freq for time features encoding, options:[s:secondly, t:minutely, h:hourly, d:daily, b:business days, w:weekly, m:monthly], you can also use more detailed freq like 15min or 3h')
parser.add_argument('--checkpoints', type=str, default='../Hop_checkpoints/', help='location of model checkpoints')
...
parser.add_argument('--d_model', type=int, default=16, help='dimension of model')#ETTm2 32
parser.add_argument('--t_model', type=int, default=512, help='dimension of seq_len_time model')
parser.add_argument('--time_d', type=int, default=4, help='dimension of time')
